...
public class URLUTF8Encoder_old {
	...
	public static String encodeJavaNative(String url) {
		try {
			return java.net.URLEncoder.encode(url, "UTF-8").replace(" ", "_");
		}catch(Exception e) {
			e.printStackTrace();
		}
		return url;
